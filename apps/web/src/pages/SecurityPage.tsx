...
const ROADMAP = [
  {
    title: 'SOC 2 Type II',
    desc: 'Control programme and evidence collection are underway as we prepare for an independent Type II assessment.',
  },
  {
    title: 'HIPAA readiness',
    desc: 'We are building the operational and contractual path toward BAAs for healthcare customers who need them.',
  },
  {
    ...
    <div className="min-h-screen bg-voice-bg text-voice-text font-sans selection:bg-voice-accent selection:text-voice-on-accent pt-28 pb-20">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center mb-20">
        ...
        <div className="relative">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-5 leading-[1.05] tracking-tight">
            Security you can inspect — and a clear compliance roadmap.
          </h1>
      ...
      <div className="max-w-3xl mx-auto px-6 mb-20">
        ...
        <p className="text-voice-muted mb-8 leading-relaxed">
          SOC 2 and HIPAA compliance work is currently in progress, alongside SSO, private deployment,
          and independent assurance. We share this roadmap openly so procurement and security teams
          can plan alongside us — and we are happy to walk through timelines on a call.
        </p>
